...
Read-only policy lookup, checklist generation, deadline lookup, and document comparison are allowed. Submission, email, deletion, and permission changes require explicit approval and remain simulated even after approval in this research implementation.
